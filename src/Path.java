 ...
 * Path
 * 
 *   A simple method for tracking Paths in an adjacency list, plus the route of those paths.
 *   
 *   @author Alex Lacey
 *   @version 20171113
 */
...
public class Path implements Comparable<Path> {
	...
	public Path(String nodename, double cost, ArrayList<String> route) {
	 ...
	 */
	@Override
	public int compareTo(Pathextra other) {
	...
	public boolean equals(Object obj) {
		...
		if ((obj == null) || (getClass() != obj.getClass()))
			...
			Pathextra other = (Pathextra) obj;
			if ((cost != other.cost) || (!endpoint.equals(other.endpoint)) || (!route.equals(other.route))) {
				eq=false;
			}
		}
		return eq;
